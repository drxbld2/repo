...
drxini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.durextv2/resources/ivue','addons2.ini.ini'))
...
iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.durextv2/resources/ivue'))
...
drxaddons2ini = 'http://drxbld.com/xml/addons2.ini'
drxcatini = 'http://drxbld.com/xml/categories.ini'
drxsetxml = 'http://drxbld.com/xml/settings.xml'
drxskins = 'https://archive.org/download/DurexTV/Durex_TV.zip'
